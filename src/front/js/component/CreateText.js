      ...
      <Row>
        <Col>
          <p id="colored-p">
            ...
            ownership or copy/paste a new NFT into existence. NFT stands for
            non-fungible token. Non-fungible is an economic term that you could
            use to describe things like your furniture, a song file, or your
            computer. These things are not interchangeable for other items
            because they have unique properties. Fungible items, on the other
            hand, can be exchanged because their value defines them rather than
            their unique properties. For example, ETH or dollars are fungible
          ...
          <Card style={{ width: "18rem" }}>
            ...
            <Card.Body>
              ...
              <Card.Text>
                ...
                collection at <a href="azuki.com/gallery">azuki.com/gallery.</a>
              </Card.Text>
              <Button
                variant="info"
